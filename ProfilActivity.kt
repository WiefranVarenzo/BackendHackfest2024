...
class ProfilActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v?.id) {
            ...
            R.id.back_arrow-> {
                val moveIntent = Intent(this@ProfilActivity,Homepage ::class.java)
            ...
            R.id.ExplorePage -> {
                val moveIntent = Intent(this@ProfilActivity, ExploreActivity ::class.java)
                startActivity(moveIntent)
            }
            R.id.MapPage -> {
                val moveIntent = Intent(this@ProfilActivity, MapActivity ::class.java)
                startActivity(moveIntent)
            }
            R.id.MessagePage -> {
                val moveIntent = Intent(this@ProfilActivity, notificationActivity ::class.java)
                startActivity(moveIntent)
            }
            R.id.ProfilPage -> {
                val moveIntent = Intent(this@ProfilActivity, ProfilActivity ::class.java)
                startActivity(moveIntent)
            }
